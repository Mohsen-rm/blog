...
<body>
    ...
    <div class="main-wrapper">
	    <section class="cta-section theme-bg-light py-5">
		    <div class="container text-center">
			    <h2 class="heading">Mohsen Al-Jayashi's blog</h2>
			    <div class="intro">Here I publish everything related to technology, and some of my work on this blog is supported by artificial intelligence</div>
			    <form class="signup-form form-inline justify-content-center pt-3">
                    <div class="form-group">
                        <label class="sr-only" for="isearch"></label>
                        <input type="email" id="input_search" name="input_search" class="form-control mr-md-1 semail" placeholder="Search in blog">
                    </div>
    ...
    <?php include('home/colors.php'); ?>
    <?php include('home/scripts.php'); ?> 
